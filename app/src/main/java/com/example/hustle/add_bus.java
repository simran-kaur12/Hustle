...
public class add_bus extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        route_Adapter = ArrayAdapter.createFromResource(this, R.array.cities, R.layout.support_simple_spinner_dropdown_item);
        cat_Adapter = ArrayAdapter.createFromResource(this, R.array.category, R.layout.support_simple_spinner_dropdown_item);
    ...
    private boolean tcheck() {
        ...
        }else if(AM_PM.equals("PM") &&AM_PM1.equals("AM")){
            return false;
        }
        return true;
    }
