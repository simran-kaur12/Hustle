    ...
    import com.example.hustle.fragments.DownloadFragment;
    import com.example.hustle.R;
    import com.example.hustle.fragments.frag_Reschdule;
    ...
    public class DashBoard extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            src_arrayAdapter = new ArrayAdapter<>(this,R.layout.simple_spinner,src_list);
            dest_arrayAdapter = new ArrayAdapter<>(this,R.layout.simple_spinner,dest_list);
        ...
        private void fetch_data() {
            listener = databaseReference1.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for(DataSnapshot snapshot1 : snapshot.getChildren()) {
                            if (snapshot1.child("Source").getValue() != null) {
